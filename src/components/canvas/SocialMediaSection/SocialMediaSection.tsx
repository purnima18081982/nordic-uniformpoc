      ...
      <div className="flex w-1/2 items-center justify-between gap-4 py-10 text-2xl">
        {buttonConfigs.map((config, index) => (
          <Button
            ...
            slotIndex={slotIndex}
            text={config.text}
            textColor={component?.parameters?.textcolor?.value as string | undefined}
            textSize={component?.parameters?.textsize?.value as undefined}
            textWeight={component?.parameters?.textweight?.value as undefined}
            textTransform={component?.parameters?.texttransform?.value as string | undefined}
            border={component?.parameters?.buttonborder?.value as string | undefined}
            icon={[
              {
                type: 'image',
                _id: `unique-id-${index}`,
            ...
            iconPosition={component?.parameters?.iconposition?.value as undefined}
